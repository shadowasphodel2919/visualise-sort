...
import static SleepPackage.Sleep.microToNano;
import static SleepPackage.Sleep.milliToNano;
...
public class SortArray extends JPanel {
	...
	public void swap(int firstIndex, int secondIndex, int milliSecDelay) {
		...
		repaint();
		sleepFor(milliToNano(milliSecDelay));
	}
	public void updateSingle(int index, int value, int milliSecDelay) {
		array[index] = value;
